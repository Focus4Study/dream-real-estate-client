        ...
        <div className='bg-fixed rounded-lg py-16' style={{backgroundImage: 'url(https://i.ibb.co/Twn0qpG/2151004003.jpg)'}}>
            <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                ...
                <div className="p-4 space-y-2 text-sm dark:text-gray-600">
                    <p> Review description Vivamus sit amet turpis leo. Praesent varius eleifend elit, eu dictum lectus consequat vitae. Etiam ut dolor id justo fringilla finibus.</p>
                </div>
            </div></SwiperSlide>
