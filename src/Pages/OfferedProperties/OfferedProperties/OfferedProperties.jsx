        ...
        <div>
            ...
            <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full p-6 text-xs text-left whitespace-nowrap tabs-boxed table-zebra-zebra md:hidden">
                        <colgroup>
                            <col className="w-5" />
                            <col />
                            <col />
                    ...
                    <table className="w-full p-6 text-xs text-left whitespace-nowrap tabs-boxed table-zebra-zebra hidden sm:block">
